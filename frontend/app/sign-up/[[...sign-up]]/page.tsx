...
//               Get started for free. Upload your first legal document and understand it in minutes.
//             </p>
//           </div>
//
...
//               ))}
//             </div>
//             <p className="text-sm text-background/50">10,000+ users trust LegalEase</p>
//           </div>
//         </div>
//
//         {/* Footer */}
...
//         />
//         <div className="pointer-events-none absolute bottom-0 left-0 w-72 h-72 opacity-8"
//           style={{ background: "radial-gradient(circle at bottom left, oklch(0.55 0.16 45) 0%, transparent 70%)" }}
//         />
//
//         {/* Mobile brand */}
...
//           </div>
//           <span className="text-lg font-serif font-bold">LegalEase Nepal</span>
//         </div>
//
